...
SYSCTL_RCGCGPIO_R       EQU   0x400FE608
    ...
    THUMB
    EXPORT  Start
Start         ; TExaS_Init sets bus clock at 80 MHz
...
loop          LDR    R0,    =GPIO_PORTE_DATA_R      ; Read address of data into R0
...
delay         LDR    R3,    =0x0014C080             ; Load 272000 into R3
wait          SUBS   R3,    R3,    #1               ; Subtract one from R3 until 0
              BNE    wait                           ; Repeat decrement
switch        AND    R2,    R1,    #0x01            ; Check if the light is on
...
turnoff       MOV    R1,    #0x01                   ; Turn the led on
